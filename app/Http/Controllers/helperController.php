...
class HelperController extends Controller
{
    ...
    {
        if ($permission == "user") {
            return 'user:basic-update|user:recover-pass|user:olny-me-delete';
        }
        if ($permission == "admin") {
            return 'user:list|user:update|user:create|user:pay|user:recover-pass|user:delete|admin:ticket-list|admin:ticket-resolve|admin:csv-user';
        }
        return null;
    }
}
