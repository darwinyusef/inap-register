...
<html lang="en">
  ...
  <head>
    ...
    <title>Respuesta - Usuario Antiguo | InapAyudas </title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block">
          <a class="nav-link js-scroll-trigger" href="index.php#inscription"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="http://portal.diagnosticar.com.co/portal/img/logo.png" alt=""></a>
        </span>
      </a>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          ...
          <div class="subheading mb-5">Inap Ayudas Pedagógicas</a>
           ...
           <a href="http://inapayudaspedagogicas.com.co/moodle/login/index.php" class="btn btn-success btn-lg">Ingresar a Moodle</a>
           <a href="https://api.whatsapp.com/send?phone=573102079111&text=Hola%20acabo%20de%20inscribirme" class="btn btn-primary btn-lg">Contactar el Soporte</a>
           ...
           <a href="https://api.whatsapp.com/send?phone=573102079111&text=Hola%20acabo%20de%20inscribirme"><img src="http://inapayudaspedagogicas.com.co/moodle/register/img/whatsapp.jpg" alt="Whatsapp" style="width:80%; margin:20px"/></a>
           <br/>
          <p class="mb-5"> Este es el tutorial de como ingresar a la plataforma paso a paso si desean descargar el tutorial en pdf haga <a href="http://inapayudaspedagogicas.com.co/moodle/register/tutorial.pdf">click aquí</a></p>
