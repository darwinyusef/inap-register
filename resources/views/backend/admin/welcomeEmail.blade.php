...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%; height: 100%; -webkit-font-smoothing: antialiased; text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; line-height: 100%;
 ...
 max-width: 560px;" class="container">
                    ...
                    <tr>
                        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
      padding-top: 20px;" class="hero"><a target="_blank" style="text-decoration: none;" href="#"><img border="0"
                                    vspace="0" hspace="0" src="{{ env('APP_URL') }}/assets/img/logodiagnosticar.jpg"
                                    alt="Please enable images to view this content" title="Aquicreamos" width="560"
                                    style="
      width: 100%;
      max-width: 560px;
   ...
   font-family: sans-serif;" class="subheader">
                            Hola, {{ $name }}! Reciba un Cordial saludo de parte de todo nuestro equipo; Le
                            damos la bienvenida a nuestra plataforma!.
                            <br /><br />
                            Usted esta inscrit@ en nuestro sistema con numero de identificación:
                            {{ $card_id }}<br><br>
                            Para acceder a ella ingrese al siguiente Link: <a href="{{ $url }}">Darse de
                                Alta</a> <br>
                    ...
                    <tr>
                        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
   padding-top: 20px;" class="hero"><a target="_blank" style="text-decoration: none;" href="#"><img border="0"
                                    vspace="0" hspace="0" src="{{ env('APP_URL') }}/assets/img/lab.jpg"
   ...
   padding-top: 25px;
   padding-bottom: 5px;" class="button"><a href="http://inapayudaspedagogicas.com.co/moodle/register/tutorial.pdf"
   ...
   color: #000000;
   font-family: sans-serif;" class="paragraph">
                Tiene alguna pregunta? <a href="mailto:wsgestor@gmail.com" target="_blank"
                    style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">wsgestor@gmail.com</a>
            </td>
        </tr>
 ...
 max-width: 560px;" class="wrapper">
                ...
                <table width="256" border="0" cellpadding="0" cellspacing="0" align="center"
                    ...
                    <tr>
                        ...
                        <td align="center" valign="middle"
                            ...
                            <a target="_blank" href="" style="text-decoration: none;"><img border="0" vspace="0"
                                    hspace="0" style="padding: 0; margin: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: inline-block;
   ...
   font-family: sans-serif;" class="footer">
                ...
                Si desea elimintar este correo de nuestras bases de datos por favor seleccione <a href="#"
                    target="_blank"
                    style="text-decoration: underline; color: #999999; font-family: sans-serif; font-size: 13px; font-weight: 400; line-height: 150%;">Eliminar
                    Usuario de nuestras bases de datos</a> en cualquier momento.
