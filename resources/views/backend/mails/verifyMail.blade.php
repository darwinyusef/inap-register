...
.footer a, .footer a:hover {
	...
	<title>Email Aqui Creamos</title>
  ...
  <tr>
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-bottom: 3px; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 18px; font-weight: 300; line-height: 150%;
			...
			font-family: sans-serif;" class="subheader">
				...
				Hola, {{$name}}! Cordial saludo;  Te queda sólo un paso más!.
				<br/><br/>
				Lo sabemos, es bastante molesto, pura burocracia, pero debido a la ley de protección de datos de Mayo/2018, necesitamos nos confirmes que realmente este es tu correo y esta activo.
		</td>
	</tr>
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
			...
			font-family: sans-serif;" class="paragraph">
				Haz click en el siguiente botón para confirmarlo, tenga en cuenta la aceptación de nuestras politicas de tratamiento de datos <a target="_blank" style="text-decoration: none;"
  			href="http://aquicreamos.com/page/politicas">aquí</a></td>
	</tr>
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			...
			href="{{url('/sendValidator/'.$active.'?email='.$email.'&remember_token='.$validate_token)}}" target="_blank" style="text-decoration: underline;">
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
			...
			font-family: sans-serif;" class="paragraph">
				...
				<br><br>
				si no puede acceder has click  "<a href="{{url('/sendValidator/'.$active.'?email='.$email.'&remember_token='.$validate_token)}}">Aqui</a>"
		</td>
	</tr>
