...
<table border="0" cellpadding="0" cellspacing="0" align="center"
  ...
  <tr>
    <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
      ...
      src="{{env('APP_URL')}}/assets/img/logodiagnosticar.jpg"
      alt="Please enable images to view this content" title="Aquicreamos"
      width="560" style="
      width: 100%;
      max-width: 560px;
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
			padding-top: 20px;" class="hero"><a target="_blank" style="text-decoration: none;"
			href="#"><img border="0" vspace="0" hspace="0"
			src="{{env('APP_URL')}}/assets/img/lab.jpg"
			alt="Please enable images to view this content" title="Imagen de muestra"
			width="560" style="
			width: 100%;
			max-width: 560px;
			color: #000000; font-size: 13px; margin: 0; padding: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block;"/></a></td>
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-bottom: 3px; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 18px; font-weight: 300; line-height: 150%;
			...
			font-family: sans-serif;" class="subheader">
				Hola, {{$name}}! Reciba un Cordial saludo de parte de todo nuestro equipo; Le damos la bienvenida a nuestra plataforma!.
				<br/><br/>
				Usted esta inscrit@ en nuestro sistema con numero de identificacion: {{$card_id}} <br><br>
				Para acceder Puede ingresar a los siguientes enlaces: <br>
				1. <a target="_blank" href="http://portal.diagnosticar.com.co/login">Sistema de Certificaciones</a> <br>
				2. <a target="_blank" href="http://inapayudaspedagogicas.com.co/moodle/login/index.php">Curso online</a> <br>
	...
	<!-- HERO IMAGE -->
	<!-- Image text color should be opposite to background color. Set your url, image src, alt and title. Alt text should fit the image size. Real image size should be x2 (wrapper x2). Do not set height for flexible images (including "auto"). URL format: http://domain.com/?utm_source={Campaign-Source}&utm_medium=email&utm_content={脤mage-Name}&utm_campaign={Campaign-Name} -->
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
			...
			<strong>Sistema de Certificaciones:</strong>
		    <br>
		    Usuario: {{$email}}<br>
			Password: {{$password}}
	</tr>
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			...
			href="http://inapayudaspedagogicas.com.co/moodle/register/tutorial.pdf" target="_blank" style="text-decoration: underline;">
				<table border="0" cellpadding="0" cellspacing="0" align="center" style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;"><tr><td align="center" valign="middle" style="padding: 12px 24px; margin: 0; text-decoration: underline; border-collapse: collapse; border-spacing: 0; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; -khtml-border-radius: 4px;"
					bgcolor="#E9703E"><p style="text-decoration: underline;
					color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;">
							 Ver nuestro tutorial
					</p>
			</td></tr></table></a>
		</td>
	</tr>
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
			...
			color: #000000;
			font-family: sans-serif;" class="paragraph">
				Tiene alguna pregunta? <a href="mailto:wsgestor@gmail.com" target="_blank" style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">wsgestor@gmail.com</a>
		</td>
	</tr>
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 13px; font-weight: 400; line-height: 150%;
			...
			font-family: sans-serif;" class="footer">
				...
				Si desea elimintar este correo de nuestras bases de datos por favor seleccione <a href="#" target="_blank" style="text-decoration: underline; color: #999999; font-family: sans-serif; font-size: 13px; font-weight: 400; line-height: 150%;">Eliminar Usuario de nuestras bases de datos</a> en cualquier momento.
