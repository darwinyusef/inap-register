                        ...
                        @foreach ($tickets as $ticket)
                            <tr class="{{ $ticket->id }}">
                                ...
                                @if (in_array('admin:ticket-resolve', $permission))
                                    ...
                                    <td class="actions">
                                        <a style="display:inline-block" href="/backend/tickets/{{ $ticket->id }}/edit">
...
@section('pageTitle')
<h3> Listado de Ticket <a href="/backend/tickets/create" type="button" class="btn btn-success">Nuevo Ticket</a></h3>
@endsection
