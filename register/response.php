  ...
  <body id="page-top">
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-3">REGISTRO
            <span class="text-primary">SATISFACTORIO</span>
          </h1>
          <div class="subheading mb-5">Inap Ayudas Pedagógicas</a>
          </div>
          <p class="mb-5">Sus Datos han sido registrados correctamente Verifique su correo electrónico para conocer el usuario y contraseña de acceso Si no encuentra el correo electrónico en su bandeja de entrada debe hacer la repectiva busqueda en el <strong>SPAM</strong></p>
           <h3 class="mb-5">Para dar inicio al curso Online, es de vital importancia enviar un mensaje al whatsapp al +57 3202051241 para que podamos matricularle pues hasta el momento solo se encuentra inscrito. este proceso se hará en las siguientes 24 horas luego de inciar el chat por whatsapp</h3>
           <br/>
           <a href="https://api.whatsapp.com/send?phone=573202051241&text=Hola%20acabo%20de%20inscribirme"><img src="http://diagnosticar.com.co/moodle/register/img/whatsapp.jpg" alt="Whatsapp" style="width:100%; margin:20px"/></a>
           <br/>
